...
public final class FullScreenWindow extends JFrame {
  ...
  public FullScreenWindow(FullScreenExtension owner) {
    ...
    imagePanelConf.setBgColor(AppConfig.getInstance().getImagePanelBgColor());
    ...
    JComponent westComponent = ImageViewerExtensionManager.getInstance().getExtraPanelComponent(ImageViewerExtension.ExtraPanelPosition.Left);
    JComponent eastComponent = ImageViewerExtensionManager.getInstance().getExtraPanelComponent(ImageViewerExtension.ExtraPanelPosition.Right);
    JComponent northComponent = ImageViewerExtensionManager.getInstance().getExtraPanelComponent(ImageViewerExtension.ExtraPanelPosition.Top);
    JComponent southComponent = ImageViewerExtensionManager.getInstance().getExtraPanelComponent(ImageViewerExtension.ExtraPanelPosition.Bottom);
  ...
  private void addListeners() {
    ...
    addWindowStateListener(new WindowStateListener() {
      ...
      public void windowStateChanged(WindowEvent e) {
        logger.log(Level.INFO, "Full-screen window state changed: {0} to {1}", new Object[]{e.getOldState(), e.getNewState()});
      }
